<template>
  <div class="homeViewBody">
    <header>
      ...
      <img src="/img/burgers_resturang.png" alt="burger resturant" id="headerimage"/>
    </header>
    <main>
      <section id="burgers">
        <h2>Select burger🍔</h2>
      ...
      <section id="contact">
        ...
        <p>This is where you provide necessary information so that we can deliver our great burgers to your doorstep 🍔 😋</p>
        <h3>Delivery information:</h3>
          ...
          <h4>Gender:</h4>
            <div class="gender-group">
              ...
              <label>
                <input type="radio" value="Do not wish to provide" v-model="gender" />
      ...
      <div>
            <button id="sendButton" type="button" v-on:click="placeOrder"> Send Delivery
...
export default {
  ...
  methods: {
    ...
    placeOrder () {
      if (!this.fullName || !this.email || Object.keys(this.orderedBurgers).length === 0) {
      ...
      if (this.fullName || this.email || !Object.keys(this.orderedBurgers).length === 0|| !this.location.x === 0 && !this.location.y === 0) {
